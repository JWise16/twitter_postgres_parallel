...
|     | sequential | parallel |
| --- | ---------- | -------- |
| normalized (unbatched) | ![](https://github.com/JWise16/twitter_postgres_parallel/workflows/tests_normalized_sequential/badge.svg) | ![](https://github.com/JWise16/twitter_postgres_parallel/workflows/tests_normalized_parallel/badge.svg) |
| normalized (batched) | ![](https://github.com/JWise16/twitter_postgres_parallel/workflows/tests_normalizedbatch_sequential/badge.svg) |  ![](https://github.com/JWise16/twitter_postgres_parallel/workflows/tests_normalizedbatch_parallel/badge.svg) |
| denormalized | ![](https://github.com/JWise16/twitter_postgres_parallel/workflows/tests_denormalized_sequential/badge.svg) | ![](https://github.com/JWise16/twitter_postgres_parallel/workflows/tests_denormalized_parallel/badge.svg) |
...
| -----------------------| ------------------------- | ------------------------- |
| `pg_normalized`        | 1m13.34s                  | 0m10.64s                  | 
| `pg_normalized_batch`  | 2m28.87s                  | 0m16.28s                  | 
| `pg_denormalized`      | 0m24.48s                  | 0m3.69s                   | 
